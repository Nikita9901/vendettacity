...
const Story = () => {
    ...
    window.addEventListener('wheel', function(event) {
        if (window.scrollX > 50 && !anim.vcity) setAnim((prev) => {
            return {...prev, vcity: true}
        })
        if (window.scrollX > 600 && !anim.images) setAnim((prev) => {
    ...
    return(
        <div className={styles.container}>
            ...
            <img src={gta10} alt={'vendettacity'} className={classnames(styles.gtaImage, styles.image2)}/>
            <img src={gta6} alt={'vendettacity'} className={classnames(styles.gtaImage, styles.image1, anim.images? styles.activeImage:null)}/>
            <div className={styles.textBlock}>
                <div className={styles.header}>Story</div>
                <div className={styles.text}>Your story began when you moved to this city 
