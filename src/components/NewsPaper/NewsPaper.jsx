      ...
      <div className={styles.roadmap} id={"roadmap"}>
        ...
        <div className={styles.phase1}>
          ...
          <div className={styles.phase1Text}>
            ...
            the website. Applying for Verification on AtomicHub <br />
        ...
        <div className={styles.phase3}>
          ...
          <div className={styles.phase1Text}>
            1. Drop Boost Level 2. Opening the ability to create them. Boost 2
            <br />
            2. Dropping Boosts level 3. Unlocking the ability to create them.
            Boost 3<br /> 3. Dropping cars. Unlocking the ability to craft them.
            Car
          </div>
        </div>
