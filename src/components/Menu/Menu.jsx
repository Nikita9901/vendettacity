    ...
    return(
        <div className={styles.container}>
            <div className={styles.menu}>
                <div onClick={() => {
                    setMenuActive(false);
                    window.scrollTo(story.getBoundingClientRect().left + window.pageXOffset, 0);
                }}>
                    <div className={styles.anchor}>Story</div>
                </div>
                <div onClick={() => {
                    setMenuActive(false);
                    window.scrollTo(cartel.getBoundingClientRect().left + window.pageXOffset, 0);
                }}>
                    <div className={styles.anchor}>Gangs</div>
                </div>
                <div onClick={() => {
                    setMenuActive(false);
                    window.scrollTo(characters.getBoundingClientRect().left + window.pageXOffset, 0);
                }}>
                    <div className={styles.anchor}>Our NFTs</div>
                </div>
                <div onClick={() => {
                    setMenuActive(false);
                    window.scrollTo(roadmap.getBoundingClientRect().left + window.pageXOffset, 0);
                }}>
                    <div className={styles.anchor}>Roadmap</div>
                </div>
                <div onClick={() => {
                    setMenuActive(false);
                    window.scrollTo(whitepaper.getBoundingClientRect().left + window.pageXOffset, 0);
                }}>
