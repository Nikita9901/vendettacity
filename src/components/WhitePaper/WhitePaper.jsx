        ...
        <div className={styles.container} id={'whitepaper'}>
            ...
            <div className={styles.gta10}>
                ...
                <div className={styles.imprintWindow}>
                    <img src={close} alt={'close'} onClick={() => {setImprintActive(false)}} className={styles.closeButton}/>
                    <div className={styles.headerImprint}>Imprint</div>
                    <div className={styles.textAbout}>Company name: Prodeus Games LTD </div>
                    <div className={styles.textAbout}>CEO: Pavlo Mifanic</div>
                    <div className={styles.textAbout}>Address: 23, New Drum Street, London, England, E1 7AY</div>
            ...
            <div className={styles.rights}>
                <div className={styles.imprint} onClick={() => {setImprintActive(true)}}>Imprint </div>&nbsp;| All Rights Reserved 2023
            </div>
        </div>
    )
}
